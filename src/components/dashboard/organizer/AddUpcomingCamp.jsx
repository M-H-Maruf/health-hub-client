...
const AddUpcomingCamp = () => {
  ...
  const handleAddCamp = async (event) => {
    ...
    try {
      const response = await axios.post(
        "https://health-hub-server.vercel.app/upcoming-camps",
        formData
      );
      ...
      if (response.status === 200) {
        ...
        Swal.fire({
          title: "Success!",
          text: "Upcoming Camp Added Successfully!",
          icon: "success",
        ...
        Swal.fire({
          title: "Error!",
          text: "Failed To Add Upcoming Camp!",
          icon: "error",
          confirmButtonText: "OK",
        });
      }
  ...
  return (
    <div className=" w-full text-white flex flex-col justify-center items-center tracking-normal text-justify">
      ...
      >
        <form onSubmit={handleAddCamp} className="flex flex-col gap-8">
          <div >
            <label
              htmlFor="campName"
